...
Gostaríamos de agradecer ao Nuno Feliciano por todos os comentários dados durante a construção e elaboração deste trabalho e à equipa do Arquivo.PT por disponibilizar acesso aos dados arquivados através de uma API e pela consideração deste trabalho para os prémios Arquivo.PT 2021.
