...
\begin{comment}
A Tabela~\ref{tab:caracterization_rel_dataset} caracteriza os dados em termos de número de palavras contidas no título, excluindo todas as palavras que fazem parte das entidades mencionadas que estão envolvidas numa relação anotada.
