...
\item pessoas portuguesas nascidas depois de 1935 cuja profissão seja: \texit{juiz, economista, advogado, funcionário público, político, empresário ou banqueiro}
\item pessoas que têm ou tiveram pelo menos um cargo de uma lista de cargos públicos portugueses previamente seleccionados (e.g.: \texit{ministro, líder do partido, embaixador}, etc.)
\end{itemize}  
...
\texbf{TODO: quem decide o que é final? as regras ou o modelo?}
